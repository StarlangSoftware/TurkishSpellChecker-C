...
/**
 * Frees memory allocated for TrieBasedSpellChecker. Deallocated memory for n-Gram, merged and split words lists,
 * generated words array list, and the trie itself.
 * @param spell_checker TrieBasedSpellChecker object to be deallocated.
 */
 ...
 * @param candidates Array to search for candidate
